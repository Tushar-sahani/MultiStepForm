  ...
  return (
    ...
    <div className="flex justify-center items-center h-screen w-screen flex-col">
      ...
      <div className="flex justify-center">
        <div className=" flex border-2 p-6 w-1/3 text-center rounded-lg cursor-pointer relative">
        ...
        <div className=" flex border-2 ml-5 p-6 w-1/3 text-center rounded-lg cursor-pointer">
...
const Loader = () => {
  return (
    <div className="flex justify-center items-center h-screen w-screen flex-col">
      ...
      <p className="p-10 text-xl font-semibold w-1/2 text-center">
