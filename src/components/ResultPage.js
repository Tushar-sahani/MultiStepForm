...
const ResultPage = () => {
  ...
  return (
    ...
    <div className="flex justify-center items-center h-screen w-screen flex-col">
      <div className=" text-center p-7 lg:mb-10">
      ...
      <div className="flex justify-center max-md:flex-col">
        <div className=" flex border-2 p-6 max-md:m-3 lg:w-1/3 text-center rounded-lg cursor-pointer relative  transition hover:ease-in-out hover:duration-300 hover:scale-105">
          ...
          <p className=" text-xl max-md:text-sm text-left p-3"><span className="font-semibold">Foundational Math</span> Build your foundational skills in algebra, geometry and probability.</p>
          <img src={resultpage_img} alt='learning path' className="w-36 h-36 max-md:w-28 max-md:h-28"/>
        </div>
        <div className=" flex border-2 max-md:m-3 lg:ml-5 p-6 lg:w-1/3 text-center rounded-lg cursor-pointer  transition hover:ease-in-out hover:duration-300 hover:scale-105">
          <p className=" text-xl max-md:text-sm text-left p-3"><span className="font-semibold">Mathematic Thinking</span> Build your foundational skills in algebra, geometry and probability.</p>
          <img src={resultpage_img} alt='learning path' className="w-36 h-36 max-md:w-28 max-md:h-28"/>
        </div>
      </div>
    </div>
